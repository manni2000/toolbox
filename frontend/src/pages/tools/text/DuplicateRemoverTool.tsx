...
import { Trash2, Copy, Check, Sparkles, Filter } from "lucide-react";
        ...
        <div className="space-y-6">
          ...
          >
            <motion.div
              ...
              style={{ backgroundColor: `hsl(240 / 0.2)` }}
            />
            <div className="relative flex items-start gap-4">
              <motion.div
                ...
                style={{
                  backgroundColor: `hsl(240 / 0.15)`,
                  boxShadow: `0 8px 30px hsl(240 / 0.3)`,
                }}
              >
                <Filter className="h-7 w-7" style={{ color: `hsl(240)` }} />
              </motion.div>
              <div>
                <h2 className="text-2xl font-bold">Duplicate Line Remover</h2>
                <p className="mt-2 text-sm text-muted-foreground">
                  Remove duplicate lines from your text while preserving order.
                </p>
                {/* Keyword Tags */}
                <div className="flex flex-wrap gap-2 mt-4">
                  <span className="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-green-100 text-green-800 border border-green-200">duplicate remover</span>
                  <span className="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-blue-100 text-blue-800 border border-blue-200">remove duplicates</span>
                  <span className="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-purple-100 text-purple-800 border border-purple-200">unique lines</span>
                  <span className="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-orange-100 text-orange-800 border border-orange-200">text deduplication</span>
                </div>
              </div>
            </div>
          </motion.div>
