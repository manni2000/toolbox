    ...
    >
      <div className="space-y-6">
        <motion.div
          ...
          initial="hidden"
          animate="visible"
          className="relative overflow-hidden rounded-3xl border border-border bg-gradient-to-br from-muted/50 via-background to-muted/30 p-6 sm:p-8 shadow-xl"
        >
          <motion.div
            animate={{
              scale: [1, 1.2, 1],
        ...
        <motion.div
          ...
          className="rounded-xl border border-border bg-card p-6 shadow-lg transition-shadow duration-500 hover:shadow-xl"
        >
        ...
        >
          <div className="rounded-lg border border-border bg-card p-4 shadow-lg transition-shadow duration-500 hover:shadow-xl">
        ...
        <motion.div
          ...
          className="rounded-xl border border-border bg-muted/30 p-6 shadow-lg transition-shadow duration-500 hover:shadow-xl"
        >
