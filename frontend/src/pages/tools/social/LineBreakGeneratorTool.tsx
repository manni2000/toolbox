      ...
      <div className="space-y-6">
        ...
        >
          ...
          <div className="relative flex items-start gap-4">
            ...
            >
              <SeparatorHorizontal className="h-7 w-7" style={{ color: `hsl(${categoryColor})` }} />
            </motion.div>
            <div>
              <h2 className="text-2xl font-bold">Line Break Generator</h2>
              <p className="mt-2 text-sm text-muted-foreground">
                Create invisible line breaks and decorative separators for Instagram captions and social media posts.
              </p>
              {/* Keyword Tags */}
              <div className="flex flex-wrap gap-2 mt-4">
                <span className="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-green-100 text-green-800 border border-green-200">line break generator</span>
                <span className="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-blue-100 text-blue-800 border border-blue-200">instagram line break</span>
                <span className="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-purple-100 text-purple-800 border border-purple-200">caption spacer</span>
                <span className="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-orange-100 text-orange-800 border border-orange-200">invisible separator</span>
              </div>
            </div>
          </div>
        </motion.div>
