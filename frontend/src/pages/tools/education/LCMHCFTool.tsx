...
const LCMHCFTool = () => {
  ...
  return (
    ...
    <>
      ...
      <ToolLayout
      breadcrumbTitle="LCM & HCF Calculator"
          ...
          <div className="relative flex items-start gap-4">
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-2 mt-4">
                ...
                <span className="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-green-100 text-green-800 border border-green-200">lcm calculator</span>

                <span className="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-blue-100 text-blue-800 border border-blue-200">hcf calculator</span>

                <span className="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-purple-100 text-purple-800 border border-purple-200">gcd calculator</span>

                <span className="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-orange-100 text-orange-800 border border-orange-200">common factors</span>
