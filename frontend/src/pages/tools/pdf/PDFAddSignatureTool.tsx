...
import { Upload, X, FileText, Sparkles, Download, Image as ImageIcon } from "lucide-react";
          ...
          <div className="relative flex items-start gap-4">
            ...
            <div>
              ...
              <p className="mt-2 text-sm text-muted-foreground">
                Upload your signature image and add it to any PDF document. Perfect for contracts, agreements, and official documents.
              </p>
            </div>
          </div>
        </motion.div>
          ...
          <div className="space-y-6">
            ...
            <div className="rounded-xl border border-border bg-card p-6">
              <div className="flex items-center justify-between mb-4">
                <label className="text-sm font-medium">Upload Your Signature</label>
              </div>
              <div
          ...
          <div className="grid sm:grid-cols-2 gap-4 mt-4">
            <div className="p-3 bg-blue-50 rounded-lg">
              ...
              <ul className="text-sm text-blue-800 space-y-1">
                ...
                <li>• Supports PNG, JPG formats</li>
