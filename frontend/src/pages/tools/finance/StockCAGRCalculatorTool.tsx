...
export default function StockCAGRCalculatorTool() {
  ...
  return (
    <>
      ...
      <ToolLayout
      breadcrumbTitle="Stock CAGR Calculator"
      ...
      <div className="space-y-6">
          ...
          >
            ...
            <div className="relative flex items-start gap-4">
              ...
              <div>
                <h2 className="text-2xl font-bold">Stock CAGR Calculator</h2>
                <p className="mt-2 text-sm text-muted-foreground">
                  Calculate Compound Annual Growth Rate for your investments.
                </p>
                {/* Keyword Tags */}
                <div className="flex flex-wrap gap-2 mt-4">
                  <span className="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-green-100 text-green-800 border border-green-200">cagr calculator</span>
                  <span className="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-blue-100 text-blue-800 border border-blue-200">compound growth</span>
                  <span className="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-purple-100 text-purple-800 border border-purple-200">stock returns</span>
                  <span className="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-orange-100 text-orange-800 border border-orange-200">investment growth</span>
                </div>
              </div>
            </div>
          </motion.div>
