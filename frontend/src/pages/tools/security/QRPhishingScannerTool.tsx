            ...
            <div className="relative flex items-start gap-4">
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-2 mt-4">
                  ...
                  <span className="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-blue-100 text-blue-800 border border-blue-200">phishing detection</span>
                  ...
                  <span className="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-orange-100 text-orange-800 border border-orange-200">qr analysis</span>
                </div>
              </div>
            </div>
          </motion.div>
