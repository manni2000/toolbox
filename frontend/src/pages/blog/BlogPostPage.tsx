...
const BlogPostPage = () => {
  ...
  const articleSchema = {
    ...
    image: [`https://dailytools247.com${post.image}`],
    mainEntityOfPage: `https://dailytools247.com/blogs/${post.slug}`,
    author: {
      "@type": "Organization",
      name: "Dailytools247",
    },
    publisher: {
      ...
      logo: {
        "@type": "ImageObject",
        url: "https://dailytools247.com/dailytools247.png",
      },
    },
  };
  ...
  return (
    <div className="flex min-h-screen flex-col overflow-x-hidden">
      <SEOHelmet
        ...
        canonical={`https://dailytools247.com/blogs/${post.slug}`}
        ogImage={post.image}
        ogType="article"
      />
      <Helmet>
