...
export const ZipUploadZone = ({
  ...
  subtitle = `Supports ZIP, RAR, 7Z, TAR up to ${maxSize}`
}: ZipUploadZoneProps) => {
    ...
    >
      <div className="space-y-4">
        <div className={`mx-auto w-16 h-16 md:w-20 md:h-20 rounded-full flex items-center justify-center ${
          ...
          <Archive className={`w-8 h-8 md:w-10 md:h-10 ${
      ...
      <input
        ...
        className="hidden"
        title={`Select ${multiple ? 'archive files' : 'an archive file'}`}
