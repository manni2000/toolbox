...
export const toolSeoEnhancements: Record<string, ToolSeoMetadata> = {
  ...
  'image-compressor': {
    ...
    longTailKeywords: [
      'best free image compressor without watermark',
      ...
      'image size reducer without quality loss',
      'batch image compressor free online',
      'image compression tool for developers',
      'optimize images for SEO and performance',
      'image compressor for social media posts',
      'reduce image file size without watermark',
      'professional image compression online free',
    ],
