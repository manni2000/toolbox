...
export const toolSeoEnhancements: Record<string, ToolSeoMetadata> = {
  ...
  'passport-photo-resizer': {
    ...
    keywords: [
      ...
      'aadhaar photo converter',
      'government document photo',
      'visa photo resize',
      'pan card photo',
    ],
    longTailKeywords: [
      'how to resize passport photo online',
      'aadhaar photo resize under 50kb',
      'passport photo 35x45mm converter',
      'compress photo for government documents',
      'resize photo for passport application',
      'aadhaar card photo size converter',
      'visa photo resize online free',
      'pan card photo size converter',
      'driving license photo resize',
      'government document photo compressor',
    ],
    ...
    relatedTools: ['pdf-compressor', 'signature-maker', 'document-template'],
    schema: {
      type: 'SoftwareApplication',
  ...
  'pdf-compressor': {
    slug: 'pdf-compressor',
    title: 'PDF Compressor - Reduce PDF File Size Online Free',
    description: 'Compress PDF files to reduce file size while maintaining quality. Perfect for email attachments, document submissions, and web uploads.',
    keywords: [
      'pdf compressor',
      'compress pdf',
      'reduce pdf size',
    ...
    faqs: [
      ...
      },
      {
        ...
        answer: 'The compression process may remove password protection. You will need to re-apply password protection after compression if needed.',
      },
    ],
    relatedTools: ['pdf-merge', 'pdf-split', 'passport-photo-resizer'],
    schema: {
      type: 'SoftwareApplication',
      appCategory: 'Document Editor',
      operatingSystem: 'Web',
