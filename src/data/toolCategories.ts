...
export const toolCategories: ToolCategory[] = [
  {
    ...
    tools: [
      ...
      { id: "image-to-pdf", name: "Image to PDF", description: "Convert multiple images to PDF document", path: "/tools/image/to-pdf", isAvailable: true },
      { id: "image-to-word", name: "Image to Word", description: "Convert images to Word with OCR", path: "/tools/image/to-word", isAvailable: true },
  ...
  },
  {
    ...
    tools: [
      ...
      { id: "pdf-to-image", name: "PDF to JPG", description: "Convert PDF pages to images", path: "/tools/pdf/to-image", isAvailable: true },
      { id: "pdf-to-word", name: "PDF to Word", description: "Convert PDF to editable Word document", path: "/tools/pdf/to-word", isAvailable: true },
      { id: "pdf-to-powerpoint", name: "PDF to PowerPoint", description: "Convert PDF to PowerPoint slides", path: "/tools/pdf/to-powerpoint", isAvailable: true },
      { id: "pdf-to-excel", name: "PDF to Excel", description: "Extract tables from PDF to Excel", path: "/tools/pdf/to-excel", isAvailable: true },
      { id: "word-to-pdf", name: "Word to PDF", description: "Convert Word documents to PDF", path: "/tools/pdf/word-to-pdf", isAvailable: true },
      { id: "powerpoint-to-pdf", name: "PowerPoint to PDF", description: "Convert presentations to PDF", path: "/tools/pdf/powerpoint-to-pdf", isAvailable: true },
      { id: "html-to-pdf", name: "HTML to PDF", description: "Convert web pages to PDF", path: "/tools/pdf/html-to-pdf", isAvailable: true },
