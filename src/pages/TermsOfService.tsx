              ...
              <div className="space-y-8">
                <div className="rounded-xl border border-border bg-card p-6">
                  ...
                  <p className="text-muted-foreground">
                    By accessing and using ToolBox ("the Service"), you agree to be bound by these Terms of Service. 
                ...
                <div className="rounded-xl border border-border bg-card p-6">
                  ...
                  <p className="text-muted-foreground mb-4">
                    ToolBox provides free online utility tools including but not limited to:
                  </p>
                ...
                <div className="rounded-xl border border-border bg-card p-6">
                  ...
                  <p className="text-muted-foreground">
                    The ToolBox website, its original content, features, and functionality are owned by ToolBox 
                ...
                <div className="rounded-xl border border-border bg-card p-6">
                  ...
                  <p className="text-muted-foreground">
                    In no event shall ToolBox, its directors, employees, or agents be liable for any indirect, 
